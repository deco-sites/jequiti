...
function ProductShelf({
  ...
  return (
    ...
    >
        ...
        <div class="relative">
            <Slider class="override:(items-stretch) gap-4 " snap="snap-center sm:snap-start last:mr-[10px] sm:last:mr-0 flex items-stretch mx-[-8px]" slidePerView={{ desktop: 4, tablet: 3, phone: 1.25, }} >
