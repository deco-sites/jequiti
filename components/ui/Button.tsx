...
const variants = {
  primary:
    "h-[45px] rounded bg-interactive font-button text-button text-default-inverse border-transparent hover:bg-default hover:text-1-500 hover:border-interactive active:bg-interactive active:text-default-inverse active:border-transparent disabled:border-default disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none ",
  secondary:
    "h-[45px] rounded bg-transparent font-button text-button text-1-500 border-interactive hover:text-white hover:bg-interactive active:bg-interactive active:text-1-500-inverse disabled:border-default disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
  tertiary:
  ...
  icon:
    "bg-transparent text-1-500 border-transparent hover:bg-hover active:border-interactive disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
};
